...
public class CapabilitiesManager {
	...
	public DesiredCapabilities getCaps() throws IOException {
		...
		//String appUrl = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "apps" + File.separator + "App-MiCitaEnCasa-debug.apk";
