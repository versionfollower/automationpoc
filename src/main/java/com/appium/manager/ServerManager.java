...
public class ServerManager {
    ...
    public AppiumDriverLocalService getAppiumServiceForMac() {
        ...
        environment.put("PATH", "/Library/Java/JavaVirtualMachines/openjdk-11.jdk/Contents/Home/bin:/Users/user/Library/Android/sdk/tools:/Users/user/Library/Android/sdk/platform-tools:/Users/user/Library/Android/sdk/tools/bin:/Users/user/Library/Android/sdk/emulator:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin" + System.getenv("PATH"));
        environment.put("ANDROID_HOME", "/Users/user/Library/Android/sdk");
        environment.put("JAVA_HOME", "/Library/Java/JavaVirtualMachines/openjdk-11.jdk/Contents/Home");
        // environment.put("JAVA_HOME",
        // "/Library/Java/JavaVirtualMachines/jdk1.8.0_231.jdk/Contents/Home");
        return AppiumDriverLocalService.buildService(new AppiumServiceBuilder()
                .usingDriverExecutable(new File("/usr/local/bin/node"))
                .withAppiumJS(new File("/usr/local/lib/node_modules/appium/build/lib/main.js"))
                .withArgument(GeneralServerFlag.SESSION_OVERRIDE).usingPort(4723).withEnvironment(environment).withLogFile(new File(
                        params.getPlatformName() + "_" + params.getDeviceName() + File.separator + "Server.log")));
