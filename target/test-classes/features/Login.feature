...
Feature: Login scenarios
 ...
 Scenario Outline: Login with invalid user name
    ...
    Examples: 
      ...
      | invalidUsername12   | secret_sauce | Username and password do not match any user in this service. |
      | invalidUsername1234 | secret_sauce | Username and password do not match any user in this service. |
